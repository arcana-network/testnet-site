        ...
        <template #tab-0>
          ...
          <div class="feature-overviews">
            <feature-description
              ...
              :icon="feature.icon"
              :title="feature.title"
              :description-list="feature.description"
            />
          </div>
        </template>
        <template #tab-1>
  ...
  data() {
    return {
      ...
      features: [
        ...
        {
          icon: 'images/arcana-storage.svg',
          title: 'Storage',
          description: [
